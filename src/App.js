      ...
      <AnimatePresence exitBeforeEnter>
          <Routes key={location.pathname} location={location}>
            ...
            <Route path="*" element={<NotFound 
                            ...
                            openGamePage={openGamePage}
          />} />
          <Route path='/react-ecommerce-store/checkout' element={<CheckoutForm/>}/>
          <Route path='react-ecommerce-store/login' element={<Login/>}/>
          <Route path='react-ecommerce-store/signup' element={<Signup/>}/>
